...
char *gc_strtrim(char const *s, char const *set, t_collector *gc, size_t layer);
char *gc_strjoin(const char *s1, char const *s2, t_collector *gc, size_t layer);
...
char *gc_strjoinsep(const char *s1, char const *s2, char sep, t_collector *gc);
